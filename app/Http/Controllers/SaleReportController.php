...
class ReportController extends Controller
{
    ...
    { 
        ...
        $listas = DB::select('select cu.name, m.nameMenu, m.price, me.number, me.subTotal, i.total,i.customer_id 
        ...
        return view('reports.index',compact('reports','listas','listClients'));
    }
