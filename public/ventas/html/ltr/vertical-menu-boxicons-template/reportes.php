            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Reportes</h5>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <h4 class="card-title">Reporte por concepto</h4>
                                        <select class="form-control" id="basicSelect">
                                            <option>Reporte de ventas</option>
                                            <option>Reporte de pedidos</option>
                                            <option>Reporte de cuentas por cobrar</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-md-2 text-center"><br><br>
                                    <button type="button" class="btn btn-success round mr-1 mb-1">Generar</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
