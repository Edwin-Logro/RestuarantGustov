                                    ...
                                    <div Class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-borderless">
                                                <tbody>
                                                <form class="form form-vertical " action="{{ url('/menu/'.$menus->id) }}" method="post" enctype="multipart/form-data">
                                                 @csrf
                                                 {{ method_field('PATCH') }}
                                                                    ...
                                                                    <fieldset class="faq-search-width form-group position-relative w-50 mx-auto">
                                                                        ...
                                                                        <input type="text" class="form-control round form-control-lg shadow pl-2" name="price"id="price" value="{{$menus->price}}">
                                                                    </fieldset>
                                                                    <fieldset class="faq-search-width form-group position-relative w-50 mx-auto">
                                                                        <label for="first-name-icon">Description</label>
                                                                        <input type="textarea" class="form-control round form-control-lg shadow pl-2" name="description" id="description" value="{{$menus->description}}">
                                                                    </fieldset>
                                                                    <fieldset class="faq-search-width form-group position-relative w-50 mx-auto">
