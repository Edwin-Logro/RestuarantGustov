                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                @foreach($listas as $lista)
                                                                    <li class="timeline-items timeline-icon-success active">
                                                                         <p class="timeline-text">Customer:  <a href="JavaScript:void(0);">{{$lista->name}}</a></p>
                                                                          <h6 class="timeline-title">Total Sale</h6>
                                                                        
                                                                        <p class="timeline-text"> <a href="JavaScript:void(0);">{{$lista->total}}</a> bs</p>
                                                                       <?php $num=$num+$lista->total; ?><hr>
